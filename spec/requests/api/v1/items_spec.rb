...
RSpec.describe "Items", type: :request do
  describe "获取账目" do
    ...
    it "按时间筛选" do
      ...
      item1 = Item.create amount: 100, created_at: '2018-01-02', user_id: user1.id, tags_id: [tag1.id], happen_at: '2018-01-01T00:00:00+08:00'
      item2 = Item.create amount: 100, created_at: '2018-01-02', user_id: user1.id, tags_id: [tag1.id], happen_at: '2018-01-01T00:00:00+08:00'
      item3 = Item.create amount: 100, created_at: '2019-01-01', user_id: user1.id, tags_id: [tag1.id], happen_at: '2018-01-01T00:00:00+08:00'
    ...
    it "按时间筛选（边界条件2）" do
      ...
      tag1 = Tag.create name: 'tag1', sign: 'x', user_id: user1.id
      item1 = Item.create amount: 100, created_at: '2018-01-01', user_id: user1.id, tags_id: [tag1.id], happen_at: '2018-01-01T00:00:00+08:00'
      item2 = Item.create amount: 100, created_at: '2017-01-01', user_id: user1.id, tags_id: [tag1.id], happen_at: '2018-01-01T00:00:00+08:00'
